    ...
    <div class="mx-auto max-w-7xl border-b-2 px-4" style="border-color: var(--color-brand);">
        <div class="flex h-20 items-end justify-between pb-2 lg:h-24">
            ...
            <nav class="hidden items-center gap-2 lg:flex">
                <a href="/#favorites" class="rounded-md px-4 py-2.5 text-[15px] font-medium tracking-wide text-gray-200 transition-all hover:bg-white/[0.04] hover:text-[var(--color-brand)]">
                    {{ __('frontend-jbc::ui.navigation.favorites') }}
                </a>
                <a href="/#team" class="rounded-md px-4 py-2.5 text-[15px] font-medium tracking-wide text-gray-200 transition-all hover:bg-white/[0.04] hover:text-[var(--color-brand)]">
                ...
                <div class="relative" x-on:click.away="mega = false">
                    <button
                        ...
                        class="flex items-center gap-1.5 rounded-md px-4 py-2.5 text-[15px] font-medium tracking-wide text-gray-200 transition-all hover:bg-white/[0.04] hover:text-[var(--color-brand)]"
                    >
                    ...
                    <div
                        ...
                        style="border-color: var(--color-brand); background-color: #1c2127;"
                    >
                                ...
                                <div class="space-y-0.5">
                                    @if (in_array('frontend', $activeAddonKeys ?? []))
                                        <a href="{{ route('frontend.blog') }}" class="group flex items-center gap-3 rounded-lg px-3 py-3 text-sm transition-all hover:bg-white/[0.04]">
                                            ...
                                            <span class="font-medium text-gray-200 transition group-hover:text-[var(--color-brand)]">{{ __('frontend-jbc::ui.navigation.blog') }}</span>
                                    ...
                                    @if (in_array('booklist', $activeAddonKeys ?? []))
                                        <a href="{{ route('frontend.books') }}" class="group flex items-center gap-3 rounded-lg px-3 py-3 text-sm transition-all hover:bg-white/[0.04]">
                                            ...
                                            <span class="font-medium text-gray-200 transition group-hover:text-[var(--color-brand)]">{{ __('frontend-jbc::ui.navigation.booklist') }}</span>
                                            <span class="ml-auto text-xs text-gray-600 opacity-0 transition group-hover:opacity-100">&rarr;</span>
                                        </a>
                                    @endif
                            ...
                            <div class="pl-6" style="border-color: var(--color-border-muted);">
                                ...
                                <div class="space-y-0.5">
                                    <a href="{{ url('/vita') }}" class="group flex items-center gap-3 rounded-lg px-3 py-3 text-sm transition-all hover:bg-white/[0.04]">
                                        ...
                                        <span class="font-medium text-gray-200 transition group-hover:text-[var(--color-brand)]">{{ __('frontend-jbc::ui.navigation.vita') }} / {{ __('frontend-jbc::ui.navigation.mediakit') }}</span>
                                        <span class="ml-auto text-xs text-gray-600 opacity-0 transition group-hover:opacity-100">&rarr;</span>
                                    </a>
                                    <a href="{{ url('/rating') }}" class="group flex items-center gap-3 rounded-lg px-3 py-3 text-sm transition-all hover:bg-white/[0.04]">
                                        <span class="flex h-8 w-8 shrink-0 items-center justify-center rounded-md text-xs font-bold" style="background-color: rgba(255,127,80,0.12); color: var(--color-brand);">B</span>
                                        <span class="font-medium text-gray-200 transition group-hover:text-[var(--color-brand)]">{{ __('frontend-jbc::ui.navigation.rating') }}</span>
                                        <span class="ml-auto text-xs text-gray-600 opacity-0 transition group-hover:opacity-100">&rarr;</span>
                                    </a>
                                    <a href="{{ url('/privacy') }}" class="group flex items-center gap-3 rounded-lg px-3 py-3 text-sm transition-all hover:bg-white/[0.04]">
                                        ...
                                        <span class="font-medium text-gray-200 transition group-hover:text-[var(--color-brand)]">{{ __('frontend-jbc::ui.navigation.privacy') }}</span>
                                        <span class="ml-auto text-xs text-gray-600 opacity-0 transition group-hover:opacity-100">&rarr;</span>
                                    </a>
                                    <a href="{{ url('/imprint') }}" class="group flex items-center gap-3 rounded-lg px-3 py-3 text-sm transition-all hover:bg-white/[0.04]">
                                        ...
                                        <span class="font-medium text-gray-200 transition group-hover:text-[var(--color-brand)]">{{ __('frontend-jbc::ui.navigation.imprint') }}</span>
                                        <span class="ml-auto text-xs text-gray-600 opacity-0 transition group-hover:opacity-100">&rarr;</span>
                                    </a>
                                </div>
                            </div>
                ...
                <div class="ml-5 flex items-center gap-1 border-l pl-5" style="border-color: var(--color-border-muted);">
                    <a href="{{ config('frontend-jbc.social.facebook') }}" target="_blank" rel="noopener" class="rounded-lg p-2.5 text-gray-400 transition hover:bg-white/[0.04] hover:text-[var(--color-brand)]" aria-label="Facebook">
                    ...
                    <a href="{{ config('frontend-jbc.social.twitter') }}" target="_blank" rel="noopener" class="rounded-lg p-2.5 text-gray-400 transition hover:bg-white/[0.04] hover:text-[var(--color-brand)]" aria-label="Twitter">
                    ...
                    <a href="{{ config('frontend-jbc.social.instagram') }}" target="_blank" rel="noopener" class="rounded-lg p-2.5 text-gray-400 transition hover:bg-white/[0.04] hover:text-[var(--color-brand)]" aria-label="Instagram">
            ...
            <button
                ...
                :class="mobile ? 'bg-white/[0.06] text-[var(--color-brand)]' : 'text-gray-400'"
        ...
        >
            <nav class="flex flex-col gap-0.5">
                <a href="/#favorites" x-on:click="mobile = false" class="rounded-lg px-4 py-3.5 text-base font-medium text-gray-200 transition hover:bg-white/[0.04] hover:text-[var(--color-brand)]">{{ __('frontend-jbc::ui.navigation.favorites') }}</a>
                <a href="/#team" x-on:click="mobile = false" class="rounded-lg px-4 py-3.5 text-base font-medium text-gray-200 transition hover:bg-white/[0.04] hover:text-[var(--color-brand)]">{{ __('frontend-jbc::ui.navigation.aboutme') }}</a>
                <hr class="my-2" style="border-color: var(--color-border-muted);">
                @if (in_array('frontend', $activeAddonKeys ?? []))
                    <a href="{{ route('frontend.blog') }}" x-on:click="mobile = false" class="rounded-lg px-4 py-3.5 text-base font-medium text-gray-200 transition hover:bg-white/[0.04] hover:text-[var(--color-brand)]">{{ __('frontend-jbc::ui.navigation.blog') }}</a>
                @endif
                @if (in_array('booklist', $activeAddonKeys ?? []))
                    <a href="{{ route('frontend.books') }}" x-on:click="mobile = false" class="rounded-lg px-4 py-3.5 text-base font-medium text-gray-200 transition hover:bg-white/[0.04] hover:text-[var(--color-brand)]">{{ __('frontend-jbc::ui.navigation.booklist') }}</a>
                @endif
                <a href="{{ url('/proofreading') }}" x-on:click="mobile = false" class="rounded-lg px-4 py-3.5 text-base font-medium text-gray-200 transition hover:bg-white/[0.04] hover:text-[var(--color-brand)]">{{ __('frontend-jbc::ui.navigation.proofreading') }}</a>
                <a href="{{ url('/vita') }}" x-on:click="mobile = false" class="rounded-lg px-4 py-3.5 text-base font-medium text-gray-200 transition hover:bg-white/[0.04] hover:text-[var(--color-brand)]">{{ __('frontend-jbc::ui.navigation.vita') }}</a>
                <a href="{{ url('/rating') }}" x-on:click="mobile = false" class="rounded-lg px-4 py-3.5 text-base font-medium text-gray-200 transition hover:bg-white/[0.04] hover:text-[var(--color-brand)]">{{ __('frontend-jbc::ui.navigation.rating') }}</a>
                <hr class="my-2" style="border-color: var(--color-border-muted);">
                <div class="flex gap-4 px-4 py-2">
                    <a href="{{ config('frontend-jbc.social.facebook') }}" target="_blank" rel="noopener" class="rounded-lg p-2 text-gray-400 transition hover:bg-white/[0.04] hover:text-[var(--color-brand)]" aria-label="Facebook">
                    ...
                    <a href="{{ config('frontend-jbc.social.twitter') }}" target="_blank" rel="noopener" class="rounded-lg p-2 text-gray-400 transition hover:bg-white/[0.04] hover:text-[var(--color-brand)]" aria-label="Twitter">
                    ...
                    <a href="{{ config('frontend-jbc.social.instagram') }}" target="_blank" rel="noopener" class="rounded-lg p-2 text-gray-400 transition hover:bg-white/[0.04] hover:text-[var(--color-brand)]" aria-label="Instagram">
