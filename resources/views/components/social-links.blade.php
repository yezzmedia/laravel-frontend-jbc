...
<div class="flex gap-3">
    @if ($facebook)
        <a href="{{ $facebook }}" target="_blank" rel="noopener" class="text-gray-500 transition hover:text-[var(--color-brand)]" aria-label="Facebook">
    ...
    @endif
    @if ($twitter)
        <a href="{{ $twitter }}" target="_blank" rel="noopener" class="text-gray-500 transition hover:text-[var(--color-brand)]" aria-label="Twitter">
    ...
    @endif
    @if ($instagram)
        <a href="{{ $instagram }}" target="_blank" rel="noopener" class="text-gray-500 transition hover:text-[var(--color-brand)]" aria-label="Instagram">
