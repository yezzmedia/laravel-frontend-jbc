@props(['facebook' => null, 'twitter' => null, 'instagram' => null])

<div class="flex gap-3">
    @if ($facebook)
        <a href="{{ $facebook }}" target="_blank" rel="noopener" class="text-[var(--color-text-muted)] transition hover:text-[var(--color-brand)]" aria-label="Facebook">
    ...
    @endif
    @if ($twitter)
        <a href="{{ $twitter }}" target="_blank" rel="noopener" class="text-[var(--color-text-muted)] transition hover:text-[var(--color-brand)]" aria-label="Twitter">
    ...
    @endif
    @if ($instagram)
        <a href="{{ $instagram }}" target="_blank" rel="noopener" class="text-[var(--color-text-muted)] transition hover:text-[var(--color-brand)]" aria-label="Instagram">
